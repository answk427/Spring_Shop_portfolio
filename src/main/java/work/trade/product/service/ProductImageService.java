...
//*******************************//
    ...
    public List<ProductImageDto> getDetailImagesList(Long productId) {
        List<ProductImage> productImages = productImageRepository.findByProductIdAndThumbnailFalse(productId);
